...
def check_security_vulnerabilities(installed_packages: List[Tuple[str, str]]) -> List[Tuple[str, str, str]]:
...
def main():
    ...
    if vulnerabilities:
        print(f"• {len(vulnerabilities)} security vulnerability(ies) found - UPDATE IMMEDIATELY")
    ...
    print("3. Activate environment: source trading_bot_env/bin/activate (Linux/Mac) or trading_bot_env\\Scripts\\activate (Windows)")
