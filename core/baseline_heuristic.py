...
class BaselineHeuristic:
    ...
    def calculate_grid_parameters(
        ...
        try:
            ...
            reasoning = {
                ...
                "risk_level": "Conservative" if risk_multiplier <= 2.0 else "Aggressive"
            }
    ...
    def _fallback_parameters(self, symbol: str, current_price: Decimal, investment: Decimal) -> Dict:
...
def get_baseline_parameters(symbol: str, market_data: Dict, investment: Decimal = Decimal('100')) -> Dict:
    """
