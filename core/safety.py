...
class SafetyManager:
    ...
    def _initialize_circuit_breakers(self):
        ...
        self.circuit_breakers = {
            ...
            "price_deviation": CircuitBreaker("price_deviation", self.risk_limits.price_deviation_threshold, 5),
            "api_errors": CircuitBreaker("api_errors", self.risk_limits.api_error_threshold, 30)
        }
    ...
    def _trigger_safety_event(self, rule_name: str, alert_level: AlertLevel, 
                            action: SafetyAction, message: str, data: Dict = None):
    ...
    def get_safety_status(self) -> Dict:
        ...
        return {
            "active_breakers": [name for name, breaker in self.circuit_breakers.items() if breaker.triggered],
            "recent_events": [
                {
