...
class TestEnhancedErrorHandler:
    ...
    def test_enhanced_error_handler_initialization(self):
        ...
        assert isinstance(self.error_handler.connection_monitor, ConnectionHealthMonitor)
    ...
    async def test_handle_error_network_category(self):
        ...
        with patch.object(self.error_handler, '_classify_error') as mock_classify, \
             patch.object(self.error_handler, '_determine_recovery_action') as mock_recovery, \
             patch.object(self.error_handler, '_execute_recovery') as mock_execute:
    ...
    async def test_handle_error_without_session(self):
        ...
        with patch.object(self.error_handler, '_classify_error') as mock_classify:
            mock_classify.return_value = (ErrorCategory.CONFIGURATION, ErrorSeverity.MEDIUM)
