...
class TestSafetyManager:
    ...
    def test_safety_manager_circuit_breaker_initialization(
        self, safety_manager, risk_limits
    ):
        ...
        assert (
            price_deviation_breaker.threshold == risk_limits.price_deviation_threshold
        )
    ...
    def test_update_metrics(self, safety_manager):
        ...
        safety_manager.update_metrics(
            total_pnl=Decimal("500"), daily_pnl=Decimal("-25"), consecutive_losses=2
        )
    ...
    def test_update_metrics_invalid_attribute(self, safety_manager):
        ...
        safety_manager.update_metrics(
            total_pnl=Decimal("500"), invalid_attr="should_be_ignored"
        )
    ...
    def test_evaluate_safety_multiple_issues_returns_most_critical(
        self, safety_manager
    ):
...
class TestComplexScenarios:
    ...
    def test_cascading_safety_events(self, strict_safety_manager):
        ...
        strict_safety_manager.metrics.consecutive_losses = (
            4  # Exceeds consecutive losses
        )
