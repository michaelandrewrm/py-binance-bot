...
class TestSizingCalculator:
    ...
    def setup_method(self):
        ...
        self.fee_config = FeeConfig(
            maker_fee=Decimal("0.001"), taker_fee=Decimal("0.001"), use_bnb=False
        )
    ...
    def test_calculate_grid_order_size_capital_utilization(self):
        ...
        result = self.calculator.calculate_grid_order_size(
            total_capital=total_capital, num_levels=num_levels
        )
...
class TestIntegrationScenarios:
    ...
    def test_grid_trading_order_sizing(self):
        ...
        grid_result = calculator.calculate_grid_order_size(
            total_capital=total_capital, num_levels=num_grid_levels
        )
        ...
        for price in test_prices:
            ...
            # Validate the order
            is_valid, message = calculator.validate_order(
    ...
    def test_different_asset_types(self):
        ...
        test_assets = [
            ...
            (
                ...
                Decimal("0.08"),
                Decimal("1"),
            ),  # Very low price, very large step
        ]
