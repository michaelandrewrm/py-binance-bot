...
def mock_binance_client():
    ...
    client = AsyncMock()
    client.get_server_time.return_value = {"serverTime": int(datetime.now(timezone.utc).timestamp() * 1000)}
...
class TestDataGenerator:
    ...
    @staticmethod
    def create_trade(symbol="BTCUSDC", side="BUY", price=50000, quantity=0.001, timestamp=None):
